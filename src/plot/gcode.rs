...
use crate::{
    paths::{FillRegion, FillRule, PreparedSvg, Segment, Stroke},
    plot::model::{
...
mod tests {
    ...
    #[test]
    fn non_arc_bezier_curve_falls_back_to_linear_segments_when_arc_output_is_enabled() {
        ...
        assert!(!plan.gcode_lines.iter().any(|line| line.starts_with("G2 ")));
        assert!(!plan.gcode_lines.iter().any(|line| line.starts_with("G3 ")));
    }

    #[test]
    fn emits_g2g3_for_arc_like_bezier_curve_segments() {
