...
pub struct Strings {
    ...
    pub view_gcode: &'static str,
    pub copy_gcode: &'static str,
    pub save_gcode: &'static str,
    pub failed_to_save_gcode: &'static str,
    ...
    pub connection_method: &'static str,
    pub connection_method_serial: &'static str,
    pub connection_method_esp3d: &'static str,
    pub connection_method_octoprint: &'static str,
    ...
    pub octoprint_address: &'static str,
    pub octoprint_api_key: &'static str,
    pub octoprint_http_connected: &'static str,
    pub octoprint_http_request_failed: &'static str,
    pub octoprint_auth_required: &'static str,
    pub octoprint_address_required: &'static str,
    pub octoprint_printer_not_ready: &'static str,
    pub octoprint_enable_cors_hint: &'static str,
    pub secure_websocket_required: &'static str,
    pub secure_http_required: &'static str,
    pub request_timed_out: &'static str,
    ...
    pub tool_mode_pen_plotter: &'static str,
    pub tool_mode_silhouette_cutter: &'static str,
    pub blade_offset: &'static str,
    pub overcut: &'static str,
    pub corner_swivel: &'static str,
    pub silhouette_cutter_hint: &'static str,
    ...
    pub fill_spacing: &'static str,
    pub fill_angle: &'static str,
    pub fill_spacing_hint: &'static str,
    ...
    pub preview_view_mode: &'static str,
    pub preview_view_mode_2d: &'static str,
    pub preview_view_mode_3d: &'static str,
